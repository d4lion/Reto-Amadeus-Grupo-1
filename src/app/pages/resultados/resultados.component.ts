        ...
        switch (this.pClimatica) {
          case 'Caluroso':
            switch (this.dViaje) {
              case '1-2 semanas':
                if (
                  this.edad == 'Menos de 30 años' &&
                  this.pActividad == 'Deportes y Aventuras' &&
                  this.pAlojamiento == 'Hostal o Albergue'
                ) {
                  this.destinoService.destinoA = 'Tulum';
                  this.destinoService.destinoE = 'Ibiza';
                } else if (
                  this.edad == 'Menos de 30 años' &&
                  this.pActividad == 'Relax y Bienestar' &&
                  this.pAlojamiento == 'Hotel de Lujo'
                ) {
                  this.destinoService.destinoA = 'Playa del Carmen';
                  this.destinoService.destinoE = 'Santori';
                } else if (
                  this.edad == '30-50 años' &&
                  this.pActividad == 'Cultura y Museos' &&
                  this.pAlojamiento == 'Hotel de Lujo'
                ) {
        ...
        switch (this.pClimatica) {
          ...
          case 'Templado':
            if (
              ...
              this.pAlojamiento == 'Airbnb' &&
              this.pActividad == 'Deportes y Aventuras' &&
              this.dViaje == 'Más de dos semanas'
            ) {
